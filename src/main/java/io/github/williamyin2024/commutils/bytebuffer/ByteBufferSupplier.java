...
package io.github.williamyin2024.commutils.bytebuffer;
 ...
 */
public abstract class ByteBufferSupplier implements AutoCloseable {

	public static final ByteBufferSupplier NO_CACHING = new ByteBufferSupplier() {
		@Override
	...
	public static ByteBufferSupplier create() {
		return new DefaultSupplierByte();
	}
	...
	private static class DefaultSupplierByte extends ByteBufferSupplier {
	 ...
	 */
	public static class GrowableByteBufferSupplier extends ByteBufferSupplier {
