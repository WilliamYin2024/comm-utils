 ...
 */
package io.github.williamyin2024.commutils.bytes;

import io.github.williamyin2024.commutils.bytebuffer.ByteBufferSupplier;
 ...
 * - Unlike {@link BufferedInputStream#skip(long)} this class could be configured to not push skip() to
 ...
 * - Unlike {@link BufferedInputStream}, which allocates an intermediate buffer, this uses a buffer supplier to
 * create the intermediate buffer.
 * - Unlike {@link BufferedInputStream}, this implementation does not support {@link InputStream#mark(int)} and
...
public class ChunkedBytesStream extends FilterInputStream {
	 ...
	 */
	private final ByteBufferSupplier bufferSupplier;
	/**
	...
	public ChunkedBytesStream(InputStream in, ByteBufferSupplier bufferSupplier, int intermediateBufSize, boolean delegateSkipToSourceStream) {
		super(in);
